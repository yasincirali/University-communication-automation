...
public class TeacherReceivedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_received);
        actionbarMessage=(Toolbar)findViewById(R.id.received_message_actionbar);
        Intent intent7=getIntent();
        final String sender_email= (String) intent7.getStringExtra(MessageAvtivity.SENDER_INFO);
        db=new DatabaseHelper(this);
        setSupportActionBar(actionbarMessage);
        getSupportActionBar().setTitle("                 Received Messages");

        ListView listView=(ListView)findViewById(R.id.listOfReceivedMessages);
